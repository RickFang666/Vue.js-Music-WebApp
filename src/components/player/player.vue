    ...
    <div class="top">
      ...
      <div class="bottom">
        ...
        <div class="operators">
          ...
          <div :class="disableCls" @click="prev" class="icon i-left">
            <i class="icon-prev"></i>
          </div>
          <div :class="disableCls" @click="togglePlaying" class="icon i-center">
            <i :class="playIcon"></i>
          </div>
          <div :class="disableCls" @click="next" class="icon i-right">
            <i class="icon-next"></i>
          </div>
...
export default {
  ...
  methods: {
    ...
    _getPosAndScale() {
      ...
      //miniPlayer padding left
      const paddingLeft = 40
      //miniPlayer paddingBottom
 ...
 @import "~common/stylus/variable"
  ...
  .player
    ...
    .mini-player
      ...
      width: 100%
      height: 60px
      background: $color-miniPlay-background
